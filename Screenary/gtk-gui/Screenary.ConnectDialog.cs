...
namespace Screenary
{
	public partial class ConnectDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Screenary.ConnectDialog
			this.Name = "Screenary.ConnectDialog";
			...
			// Internal child Screenary.ConnectDialog.VBox
			...
			w8.Fill = false;
			w8.Padding = ((uint)(6));
			// Internal child Screenary.ConnectDialog.ActionArea
